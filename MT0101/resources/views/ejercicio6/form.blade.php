...
<ul>
    ...
    <div style="text-align: center;color:brown;padding-top:5%;">
        <h1><strong>Ejercicio 6º</strong></h1>
    </div>
    <br>
    
    <div>
        <form action="blade-result-6" method="POST" style="width: 200px;margin-left: auto;margin-right: auto;">
            @csrf
            <label for="" style="color: blue;"><h2><strong>Ingrese el número :</strong></h2></label>
