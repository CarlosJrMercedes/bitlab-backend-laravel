...
<ul>
    ...
    <div style="text-align: center;color:brown;padding-top:5%;">
        <h1><strong>Ejercicio 2º</strong></h1>
    </div>
    <br>
    
    <div>
        <form action="blade-result-2" method="POST" style="width: 200px;margin-left: auto;margin-right: auto;">
            @csrf
            <label for="" style="color: blue;"><h2><strong>Ingrese la frase :</strong></h2></label>
            <textarea type="text" name="frase"  class="caja" maxlength="50" required></textarea>
            <br>
            <br>
