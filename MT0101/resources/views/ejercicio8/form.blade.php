...
<ul>
    ...
    <div style="text-align: center;color:brown;padding-top:5%;">
        <h1><strong>Ejercicio 1º</strong></h1>
    </div>
    <br>
    
    <div>
        <form action="blade-result-8" method="POST" style="text-align: center;margin-left: auto;margin-right: auto;">
            @csrf
            <label for="" style="color: blue;"><h2><strong>Ingrese el primer año :</strong></h2></label>
            <input type="text" name="uno" require class="caja">
            <label for="" style="color: blue;"><h2><strong>Ingrese el segundo año :</strong></h2></label>
            <input type="text" name="dos" require class="caja">
            <br>
            <br>
