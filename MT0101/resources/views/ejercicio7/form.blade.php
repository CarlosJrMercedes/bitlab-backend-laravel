...
<ul>
    ...
    <div style="text-align: center;color:brown;padding-top:5%;">
        <h1><strong>Ejercicio 7º</strong></h1>
    </div>
    <br>
    
    <div>
        <form action="blade-result-7" method="POST" style="text-align: center;margin-left: auto;margin-right: auto;">
            @csrf
            <label for="" style="color: blue;"><h2><strong>Ingrese un número de " l " 1 al " 10 " :</strong></h2></label>
            <input type="text" name="num" require class="caja">
            <br>
            <br>
