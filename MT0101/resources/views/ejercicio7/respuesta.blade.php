...
<ul>
    ...
    <br>
        <p><strong><h2>Los libros seleccionados son :</h2></strong></p>
        <ol>
        ...
        <p><strong><h2>Los libros no seleccionados son :</h2></strong></p>
        <ol>
            @foreach($restantes as $rest)
            <li><p><strong>{{$rest}}.</strong></p></li>
            @endforeach
        </ol>
