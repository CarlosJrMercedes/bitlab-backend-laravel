...
<body>
    ...
    <div>
        <form action="blade-result-1" method="POST" style="width: 200px;margin-left: auto;margin-right: auto;">
            @csrf
            <label for="" style="color: blue;"><h2><strong>Ingrese su edad :</strong></h2></label>
            <input type="text" name="edad" required class="caja">
            <br>
            <br>
